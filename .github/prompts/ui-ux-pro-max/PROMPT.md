...
Comprehensive design guide for web and mobile applications. Contains 67 styles, 161 color palettes, 57 font pairings, 99 UX guidelines, and 25 chart types across 16 technology stacks. Searchable database with priority-based recommendations and AI-powered reasoning engine for 161 industry-specific design systems.

**Stack en este proyecto**: Astro (Vanilla CSS, no Tailwind). Al implementar, adaptar todos los ejemplos de código a CSS nativo con custom properties.
